...
typedef struct {
  PyObject_HEAD ancestor_builder_t *builder;
} AncestorBuilder;

typedef struct {
  PyObject_HEAD tree_sequence_builder_t *tree_sequence_builder;
} TreeSequenceBuilder;

typedef struct {
  PyObject_HEAD ancestor_matcher_t *ancestor_matcher;
  TreeSequenceBuilder *tree_sequence_builder;
} AncestorMatcher;

static void handle_library_error(int err) {
...
static int uint64_PyArray_converter(PyObject *in, PyObject **out) {
...
static int AncestorBuilder_check_state(AncestorBuilder *self) {
  int ret = 0;
...
static void AncestorBuilder_dealloc(AncestorBuilder *self) {
  if (self->builder != NULL) {
...
static int AncestorBuilder_init(AncestorBuilder *self, PyObject *args,
                                PyObject *kwds) {
  int ret = -1;
  int err;
  static char *kwlist[] = {"num_samples", "max_sites", "genotype_encoding",
                           "mmap_fd", NULL};
  ...
  Py_BEGIN_ALLOW_THREADS err = ancestor_builder_alloc(
      self->builder, num_samples, max_sites, mmap_fd, flags);
...
static PyObject *AncestorBuilder_add_site(AncestorBuilder *self, PyObject *args,
                                          PyObject *kwds) {
  int err;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "dOk", kwlist, &time, &genotypes,
                                   &derived_count)) {
    goto out;
  }
  ...
  Py_BEGIN_ALLOW_THREADS err = ancestor_builder_add_site(
...
static PyObject *AncestorBuilder_make_ancestor(AncestorBuilder *self,
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "OO!", kwlist, &focal_sites,
                                   &PyArray_Type, &ancestor)) {
    goto out;
  }
  ...
  if (num_focal_sites == 0 || num_focal_sites > num_sites) {
    PyErr_SetString(PyExc_ValueError,
                    "num_focal_sites must > 0 and <= num_sites");
    goto out;
  }
  ...
  Py_BEGIN_ALLOW_THREADS err = ancestor_builder_make_ancestor(
      self->builder, num_focal_sites,
...
static PyObject *AncestorBuilder_ancestor_descriptors(AncestorBuilder *self) {
  PyObject *ret = NULL;
...
static PyObject *AncestorBuilder_get_num_sites(AncestorBuilder *self,
                                               void *closure) {
  PyObject *ret = NULL;
...
static PyObject *AncestorBuilder_get_num_ancestors(AncestorBuilder *self,
                                                   void *closure) {
  PyObject *ret = NULL;
...
static PyObject *AncestorBuilder_get_memsize(AncestorBuilder *self,
                                             void *closure) {
  PyObject *ret = NULL;
...
static int TreeSequenceBuilder_check_state(TreeSequenceBuilder *self) {
  int ret = 0;
...
static void TreeSequenceBuilder_dealloc(TreeSequenceBuilder *self) {
  if (self->tree_sequence_builder != NULL) {
...
static int TreeSequenceBuilder_init(TreeSequenceBuilder *self, PyObject *args,
                                    PyObject *kwds) {
  int ret = -1;
  int err;
  ...
  err = tree_sequence_builder_alloc(self->tree_sequence_builder, num_sites,
                                    PyArray_DATA(num_alleles), max_nodes,
                                    max_edges, flags);
  if (err != 0) {
    handle_library_error(err);
    goto out;
...
static PyObject *TreeSequenceBuilder_add_node(TreeSequenceBuilder *self,
                                              PyObject *args, PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  err = tree_sequence_builder_add_node(self->tree_sequence_builder, time,
                                       (uint32_t)flags);
  if (err < 0) {
    handle_library_error(err);
    goto out;
...
static PyObject *TreeSequenceBuilder_add_path(TreeSequenceBuilder *self,
                                              PyObject *args, PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  int flags = 0;
   ...
   * by other threads. */
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_add_path(
      self->tree_sequence_builder, child, num_edges,
...
static PyObject *TreeSequenceBuilder_add_mutations(TreeSequenceBuilder *self,
                                                   PyObject *args,
                                                   PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "kOO", kwlist, &node, &site,
                                   &derived_state)) {
    goto out;
  }
  ...
  /* site */
  site_array =
      (PyArrayObject *)PyArray_FROM_OTF(site, NPY_INT32, NPY_ARRAY_IN_ARRAY);
  if (site_array == NULL) {
    goto out;
  }
   ...
   * be modified in Python. Must make sure that these arrays are not modified
   * by other threads. */
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_add_mutations(
      self->tree_sequence_builder, node, num_mutations,
...
static PyObject *TreeSequenceBuilder_restore_nodes(TreeSequenceBuilder *self,
                                                   PyObject *args,
                                                   PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_restore_nodes(
      self->tree_sequence_builder, num_nodes,
...
static PyObject *TreeSequenceBuilder_restore_edges(TreeSequenceBuilder *self,
                                                   PyObject *args,
                                                   PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "OOOO", kwlist, &left, &right,
                                   &parent, &child)) {
    goto out;
  }
  ...
  /* left */
  left_array =
      (PyArrayObject *)PyArray_FROM_OTF(left, NPY_INT32, NPY_ARRAY_IN_ARRAY);
  if (left_array == NULL) {
    goto out;
  }
  if (PyArray_NDIM(left_array) != 1) {
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_restore_edges(
...
static PyObject *
TreeSequenceBuilder_restore_mutations(TreeSequenceBuilder *self, PyObject *args,
                                      PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "OOOO", kwlist, &site, &node,
                                   &derived_state, &parent)) {
    goto out;
  }
  ...
  /* node */
  node_array =
      (PyArrayObject *)PyArray_FROM_OTF(node, NPY_INT32, NPY_ARRAY_IN_ARRAY);
  if (node_array == NULL) {
    goto out;
  }
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_restore_mutations(
      self->tree_sequence_builder, num_mutations,
      (tsk_id_t *)PyArray_DATA(site_array),
...
static PyObject *TreeSequenceBuilder_dump_nodes(TreeSequenceBuilder *self) {
  int err;
  PyObject *ret = NULL;
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_dump_nodes(
      self->tree_sequence_builder, (uint32_t *)PyArray_DATA(flags),
...
static PyObject *TreeSequenceBuilder_dump_edges(TreeSequenceBuilder *self) {
  int err;
  PyObject *ret = NULL;
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_dump_edges(
      self->tree_sequence_builder, (tsk_id_t *)PyArray_DATA(left),
      (tsk_id_t *)PyArray_DATA(right), (tsk_id_t *)PyArray_DATA(parent),
...
static PyObject *TreeSequenceBuilder_dump_mutations(TreeSequenceBuilder *self) {
  int err;
  PyObject *ret = NULL;
  ...
  Py_BEGIN_ALLOW_THREADS err = tree_sequence_builder_dump_mutations(
      self->tree_sequence_builder, (tsk_id_t *)PyArray_DATA(site),
      (tsk_id_t *)PyArray_DATA(node), (allele_t *)PyArray_DATA(derived_state),
...
static PyObject *TreeSequenceBuilder_freeze_indexes(TreeSequenceBuilder *self) {
  int err;
  PyObject *ret = NULL;
...
static PyObject *TreeSequenceBuilder_get_num_edges(TreeSequenceBuilder *self,
                                                   void *closure) {
  PyObject *ret = NULL;
...
static PyObject *TreeSequenceBuilder_get_num_nodes(TreeSequenceBuilder *self,
                                                   void *closure) {
  PyObject *ret = NULL;
...
static PyObject *
TreeSequenceBuilder_get_num_match_nodes(TreeSequenceBuilder *self,
                                        void *closure) {
  PyObject *ret = NULL;
...
static PyObject *TreeSequenceBuilder_get_num_sites(TreeSequenceBuilder *self,
                                                   void *closure) {
  PyObject *ret = NULL;
  ...
  ret =
      Py_BuildValue("k", (unsigned long)self->tree_sequence_builder->num_sites);
out:
  return ret;
}

static PyObject *
TreeSequenceBuilder_get_num_mutations(TreeSequenceBuilder *self,
                                      void *closure) {
  PyObject *ret = NULL;
  ...
  ret =
      Py_BuildValue("k", (unsigned long)tree_sequence_builder_get_num_mutations(
                             self->tree_sequence_builder));
out:
  return ret;
}
...
static PyMethodDef TreeSequenceBuilder_methods[] = {
    ...
    {"dump_mutations", (PyCFunction)TreeSequenceBuilder_dump_mutations,
     METH_NOARGS, "Dumps mutation data into numpy arrays."},
    {"freeze_indexes", (PyCFunction)TreeSequenceBuilder_freeze_indexes,
     METH_NOARGS, "Freezes the indexes used for ancestor matching."},
    {NULL} /* Sentinel */
};
...
static int AncestorMatcher_check_state(AncestorMatcher *self) {
  int ret = 0;
...
static void AncestorMatcher_dealloc(AncestorMatcher *self) {
  if (self->ancestor_matcher != NULL) {
...
static int AncestorMatcher_init(AncestorMatcher *self, PyObject *args,
                                PyObject *kwds) {
  int ret = -1;
  int err;
  int extended_checks = 0;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!OO|Ii", kwlist,
                                   &TreeSequenceBuilderType,
                                   &tree_sequence_builder, &recombination,
                                   &mismatch, &precision, &extended_checks)) {
    goto out;
  }
  ...
  recombination_array = (PyArrayObject *)PyArray_FromAny(
      recombination, PyArray_DescrFromType(NPY_FLOAT64), 1, 1,
  ...
  if (shape[0] !=
      (npy_intp)tree_sequence_builder->tree_sequence_builder->num_sites) {
    PyErr_SetString(PyExc_ValueError,
                    "Size of recombination array must be num_sites");
    goto out;
  }
  mismatch_array = (PyArrayObject *)PyArray_FromAny(
      mismatch, PyArray_DescrFromType(NPY_FLOAT64), 1, 1, NPY_ARRAY_IN_ARRAY,
      NULL);
  ...
  if (shape[0] !=
      (npy_intp)tree_sequence_builder->tree_sequence_builder->num_sites) {
    PyErr_SetString(PyExc_ValueError,
                    "Size of mismatch array must be num_sites");
    goto out;
  }
  ...
  err =
      ancestor_matcher_alloc(self->ancestor_matcher,
                             self->tree_sequence_builder->tree_sequence_builder,
...
static PyObject *AncestorMatcher_find_path(AncestorMatcher *self,
                                           PyObject *args, PyObject *kwds) {
  int err;
  PyObject *ret = NULL;
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "OiiO!", kwlist, &haplotype,
                                   &start, &end, &PyArray_Type, &match)) {
    goto out;
  }
  ...
  Py_BEGIN_ALLOW_THREADS err = ancestor_matcher_find_path(
      self->ancestor_matcher, (tsk_id_t)start, (tsk_id_t)end,
...
static PyObject *AncestorMatcher_get_traceback(AncestorMatcher *self,
                                               PyObject *args) {
  PyObject *ret = NULL;
  unsigned long site;
...
static PyObject *AncestorMatcher_get_mean_traceback_size(AncestorMatcher *self,
                                                         void *closure) {
  PyObject *ret = NULL;
...
static PyObject *AncestorMatcher_get_total_memory(AncestorMatcher *self,
                                                  void *closure) {
  PyObject *ret = NULL;
  ...
  ret = Py_BuildValue("k", (unsigned long)ancestor_matcher_get_total_memory(
...
static PyMethodDef AncestorMatcher_methods[] = {
    {"find_path", (PyCFunction)AncestorMatcher_find_path,
     METH_VARARGS | METH_KEYWORDS,
     "Returns a best match path for the specified haplotype through the "
     "ancestors."},
...
PyObject *PyInit__tsinfer(void)

#else
#define INITERROR return

void init_tsinfer(void)
#endif
{
#if PY_MAJOR_VERSION >= 3
  ...
  PyModule_AddObject(module, "AncestorBuilder",
                     (PyObject *)&AncestorBuilderType);
  ...
  PyModule_AddObject(module, "AncestorMatcher",
                     (PyObject *)&AncestorMatcherType);
  ...
  PyModule_AddObject(module, "TreeSequenceBuilder",
                     (PyObject *)&TreeSequenceBuilderType);
  ...
  TsinfMatchImpossible =
      PyErr_NewException("_tsinfer.MatchImpossible", NULL, NULL);
