...
project = "tsinfer"
copyright = "2018, Jerome Kelleher"
...
latex_documents = [
    (master_doc, "tsinfer.tex", "tsinfer Documentation", "Jerome Kelleher", "manual"),
]
...
man_pages = [(master_doc, "tsinfer", "tsinfer Documentation", [author], 1)]
