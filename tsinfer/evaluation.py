...
def generate_errors(ts, error_p):
    """
    Returns a genotype matrix for the specified tree sequence with errors
    added.

    Rejection samples any fixed variants generated by the error process.
    """
    # TODO I'm not at all sure about this. Need to be much clearer what the
    # actual model is here and make some tests to ensure it works.
